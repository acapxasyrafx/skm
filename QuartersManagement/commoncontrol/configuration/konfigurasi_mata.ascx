...
<asp:Panel ID="PnlIndicator" runat="server">
    ...
    <asp:Label ID="lblRefresh" runat="server" Visible="false">Konfigurasi Utama > Penetapan Mata</asp:Label>
</asp:Panel>
    ...
    <tr class="fbform_header">
        ...
        <td>
            <span class="buttonMenu">
                <a href="Konfigurasi.Mata.Baru.aspx?P=<%=lbl1.Text %>" id="SaveFunction">
                    <img title="Add" style="vertical-align: middle;" src="icons/add.png" width="25" height="25" alt="::" /></a>
                | <a href="Konfigurasi.Mata.aspx?P=<%=lblRefresh.Text %>" id="Refresh">
...
<table class="fbform" style="width: 100%">
    ...
    <tr class="fbform_mheader">
        <td colspan="7">SENARAI MATA DALAM PERKHIDMATAN</td>
    </tr>
