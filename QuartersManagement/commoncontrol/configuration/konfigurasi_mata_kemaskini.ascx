<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="konfigurasi_mata_kemaskini.ascx.vb" Inherits="QuartersManagement.konfigurasi_mata_kemaskini" %>

<%-- Menu Label Indicator --%>
<asp:Panel ID="PnlIndicator" runat="server">
    <asp:Label ID="lblRefresh" runat="server" Visible="false">Konfigurasi Utama > Penetapan Mata > Kemaskini</asp:Label>
</asp:Panel>
    ...
    <tr class="fbform_header">
        ...
        <td>
            <span class="buttonMenu">
                ...
                | <a href="Konfigurasi.Mata.Kemaskini.aspx?P=<%=lblRefresh.Text %>" id="Refresh">
...
<table class="fbform" style="width: 100%">
    ...
    <tr>
        ...
        <td style="width: 20px">:</td>
        <td>
            <asp:TextBox ID="txtMata" runat="server" Width="50px"></asp:TextBox>
        </td>
    </tr>   
