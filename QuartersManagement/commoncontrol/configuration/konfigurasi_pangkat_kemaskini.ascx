<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="konfigurasi_pangkat_kemaskini.ascx.vb" Inherits="QuartersManagement.konfigurasi_pangkat_kemaskini" %>

<%-- Menu Label Indicator --%>
<asp:Panel ID="PnlIndicator" runat="server">
    <asp:Label ID="lbl1" runat="server" Visible="false">Konfigurasi Utama > Penetapan Pangkat > Kemaskini</asp:Label>
</asp:Panel>
    ...
    <tr class="fbform_header">
        ...
        <td>
            <span class="buttonMenu">
                ...
                | <a href="Konfigurasi.Pangkat.Kemaskini.aspx?P=<%=lbl1.Text %>" id="Refresh">
