<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="konfigurasi_kuota_kemaskini.ascx.vb" Inherits="QuartersManagement.konfigurasi_kuota_kemaskini" %>

<%-- Menu Label Indicator --%>
<asp:Panel ID="PnlIndicator" runat="server">
    <asp:Label ID="lblRefresh" runat="server" Visible="false">Konfigurasi Utama > Penetapan Kuota > Kemaskini</asp:Label>
</asp:Panel>
    ...
    <tr class="fbform_header">
        ...
        <td>
            <span class="buttonMenu">
                ...
                | <a href="Konfigurasi.Kuota.Kemaskini.aspx?P=<%=lblRefresh.Text %>" id="Refresh">
